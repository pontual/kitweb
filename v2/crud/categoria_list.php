...
<p>
    Elas existem para facilitar a criação de Links. Vários Links como <i>Squeezes, Garrafas, e Cantis</i>, que são sinônimos, podem existir, e todos podem apontar à mesma Lista de produtos.
</p>

<p>
    A adição ou remoção de um produto é feito apenas uma vez na Lista correta. Não é necessário manter três listas separadas para estes três Links. 
</p>
